...
COMMENT ON TABLE tunnels IS 'Stores tunnel or VPN subscription configurations (per-user, per-CF config).';
...
-- -----------------------------------------------------------------
--  Table 6: cf_configs (per-user Cloudflare credentials, multi-account)
-- -----------------------------------------------------------------
...
COMMENT ON TABLE cf_configs IS 'Per-user Cloudflare API credentials (token + account id), supports multiple accounts per user.';
